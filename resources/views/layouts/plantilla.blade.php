...
<body class="bg-white m-0 font-sans">
  <header class="">
    <nav class="fixed z-10 w-full flex justify-between items-center bg-white border-b-[1px] border-b-gray-400">
      <div class="sm:hidden flex justify-evenly w-3/12">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="searchBar cursor-pointer hover:stroke-red-500 lg:w-[25px] lg:h-[25px] w-5 h-5">
            <path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
        </svg>
      </div>
      <div class="flex flex-col items-center justify-center w-3/12">
      <a href="{{auth()->user()? route('admin.all') : '/'}}" class="w-full sm:h-24 h-[60px] flex justify-center items-center">
        <svg version="1.0" xmlns="http://www.w3.org/2000/svg" class="w-full sm:w-40" viewBox="0 0 1200.000000 900.000000" preserveAspectRatio="xMidYMid meet">
      ...
      <div class="w-full sm:hidden justify-center items-start flex gap-2 h-[36px]">
        <a href="{{route('clothes.index', ['gender' => 'H'])}}" class="font-semibold text-xs cursor-pointer hover:text-red-500">HOMBRE</a>
        <a href="{{route('clothes.index', ['gender' => 'M'])}}" class="font-semibold text-xs cursor-pointer hover:text-red-500">MUJER</a>
      </div>
      </div>
      ...
      <div class="w-3/12 flex justify-center">
        <div class="w-6/12 flex flex-wrap justify-evenly">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="searchBar cursor-pointer hover:stroke-red-500 lg:w-[25px] lg:h-[25px] w-5 h-5 sm:block hidden">
            <path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
          </svg>
  ...
  <div>
    <main class="pt-28">
      ...
      <div id="bagDiv" class="fixed z-50 h-screen max-h-screen sm:w-3/4 md:w-2/4 lg:w-1/4 w-full bg-white top-0 -right-[2000px] overflow-auto scrollbar-x-hidden">
