...
<div class="w-full flex justify-center">
    <div class="w-11/12 flex flex-wrap justify-between">
        ...
        <div class="clothesDiv group relative 2xl:w-2/12 xl:w-[250px] lg:w-[300px] sm:w-[300px] w-full mx-2 mb-10">
            <button id="{{$man->id}}" class="w-[30px] h-[30px] bg-white/40 shadow-sm shadow-[#676767] rounded-full absolute right-2 top-2 backdrop-blur-md group-hover:opacity-90 opacity-0 duration-500 ease-in-out flex justify-center items-center">
