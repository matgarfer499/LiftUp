...
@section('content')
<div class="w-11/12 flex flex-wrap justify-start m-auto mb-4">
...
<div class="w-11/12 flex flex-wrap sm:justify-end justify-between m-auto mb-4">
    ...
    <div class="w-44 h-14 border-2 border-gray-300 bg-gray-100 rounded-full flex justify-evenly items-center">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
<div class="w-full flex flex-wrap justify-center">
    ...
    <div class="clothesDiv w-[360px] mx-2 mb-10">
        <a href="{{route('images.see', ['id' => $man->id])}}">
            <img src="{{$man->images->first()?->url}}" class="clothesImg w-full h-[500px] cursor-pointer hover:border-4 hover:border-gray-400" alt>
        </a>
